...
import me.sungbin.spring.domain.orderproduct.OrderProductRepository;
...
import static me.sungbin.spring.domain.product.ProductSellingStatus.SELLING;
import static me.sungbin.spring.domain.product.ProductType.HANDMADE;
...
class OrderStatisticsServiceTest extends IntegrationTestSupport {
    ...
    void sendOrderStatisticsMail() {
        // given
        LocalDateTime now = LocalDateTime.of(2024, 10, 18, 0, 0);
        ...
        Order order1 = createPaymentCompletedOrder(products, LocalDateTime.of(2024, 10, 17, 23, 59, 59));
        Order order2 = createPaymentCompletedOrder(products, now);
        Order order3 = createPaymentCompletedOrder(products, LocalDateTime.of(2024, 10, 18, 23, 59, 59));
        Order order4 = createPaymentCompletedOrder(products, LocalDateTime.of(2024, 10, 19, 0, 0));
        ...
        // when
        boolean result = orderStatisticsService.sendOrderStatisticsMail(LocalDate.of(2024, 10, 18), "test@test,com");
